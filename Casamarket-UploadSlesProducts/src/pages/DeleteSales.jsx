...
const APISALES_URL = import.meta.env.VITE_APISALES_URL

export function DeleteSales({ user }) {
  const authData = user
  ...
  async function pollEstado() {
    try {
      const res = await fetch(
        `${APISALES_URL}/api/limpiar/estado?db_target=${dbTarget}&company_id=${companyId}`
      )
  ...
  async function handleConfirmar() {
    try {
      ...
      const res = await fetch(`${APISALES_URL}/api/limpiar`, {
        method: 'POST',
        headers: {
          ...
          <div className="w-full max-w-lg rounded-2xl border border-red-500 bg-white p-8 shadow-2xl dark:bg-gray-800">
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Esta acción eliminará toda la información relacionada con ventas
                de la empresa{' '}
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Esto incluye documentos, transacciones, órdenes, guías de remisión,
                movimientos de caja y más.
              </p>
          ...
          <div className="w-full max-w-sm rounded-2xl border border-red-500 bg-white p-8 shadow-2xl dark:bg-gray-800">
            <div className="flex flex-col items-center gap-3 text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Ingresa tu contraseña para autorizar la eliminación de ventas.
              </p>
            </div>
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              Gestiona la limpieza completa de información de ventas de la empresa.
            </p>
          </div>
        ...
        <section className="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
          <div className="border-b border-gray-200 px-6 py-5 dark:border-gray-700">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Esta operación eliminará todos los registros relacionados con ventas.
            </p>
          </div>
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-red-600 dark:text-red-300">
                    Esta acción eliminará permanentemente toda la información de ventas.
                  </p>
                </div>
