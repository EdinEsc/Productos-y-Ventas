...
export function DeleteSales({ authData }) {
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-red-600/90 dark:text-red-300">
                    Se eliminarán documentos, transacciones, órdenes, guías de remisión,
                    movimientos de caja y demás información asociada a ventas.
                  </p>
                </div>
              </div>
            </div>
