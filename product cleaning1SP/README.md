...
Si prefieres usar Docker, ya tienes todo configurado:
...
> [!IMPORTANT]
> El contenedor monta la llave SSH necesaria para el túnel. Asegúrate de que la ruta en `docker-compose.yml` (sección `volumes`) coincida con la ubicación real de tu archivo `.pem`.
